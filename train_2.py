...
_data = np.load(file="sample_train_data_total.npy", allow_pickle=True)
_label = np.load(file="sample_train_label_total.npy", allow_pickle=True)
train_data = _data[:1897,...]
train_label = _label[:1897,...]
test_data = _data[1897:,...]
test_label = _label[1897:,...]
